...
#Avant de le reutiliser penser à modifier le chemin et la vitesse
...
class player:
    def __init__(self):
        self.x = 0
        self.y = 0
        self.ani = glob.glob("ventilo/frame-*.gif") #recupérer les frames dans une array \ a modif pour linux
